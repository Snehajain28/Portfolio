...
export default function Home() {
  ...
  return (
    <div id="home" className="h-[100vh] bg-white w-[100vw]" >
      <div className="flex h-full items-center flex-col">
        <div className="h-[70px]"></div>
        <div className="flex lg:flex-row  flex-col  gap-20 justify-evenly items-center lg:mt-0 w-11/12 mx-auto ">
          <div className="flex flex-col h-full lg:gap-6 gap-4 justify-center items-center ">
            ...
            className="flex md:text-[2.1rem]  lg:mt-[1.5rem] text-[1.7rem] md:mt-20 mt-10 gap-8">
          ...
          <div className="h-[10rem]  md:h-[15rem] lg:h-[20rem]  lg:mt-[2rem] mt-[-2rem]">
