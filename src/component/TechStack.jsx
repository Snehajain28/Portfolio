...
export default function TechStack() {
    ...
    return (
        ...
        id="tech" className=' mt-[2rem] dark:bg-gradient-to-b from-gray-800 to-black dark:text-white w-full h-content'>
            <div className='max-w-screen-lg h-full p-4 mx-auto flex flex-col justify-center w-full '>
                <div className='pb-4'>
                    <p className='text-4xl font-bold w-[14rem] flex hover:scale-110 justify-center mx-auto border-b-4 border-gray-400'>TECH STACK</p>
