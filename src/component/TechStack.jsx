                ...
                <div className='w-[90vw] mx-auto h-full flex flex-wrap gap-5 lg:gap-20 lg:w-[70vw] justify-center text-center '>
                    {
                        Tech_data.map((tech, i) => (
                            <div data-aos="zoom-in" key={i} className={`dark:shadow-gray-900 dark:shadow-lg shadow-xl cursor-pointer h-[8rem]  w-[8rem] duration-500 py-2 rounded-lg`}>
                                <img src={`https://skillicons.dev/icons?i=${tech.name}&theme=${mode}`} alt="" className='w-20 h-20 mx-auto object-contain' />
