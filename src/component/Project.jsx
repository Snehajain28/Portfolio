...
export default function Project() {
  ...
  return (
    ...
    className='mt-[2rem] dark:bg-gradient-to-b from-gray-900 to-black dark:text-white w-full h-content'>
      <h2 className='text-4xl text-center mb-7 w-[12rem] flex justify-center mx-auto  font-bold inline border-b-4 border-gray-400'>
        PROJECTS
      </h2>
      <div className=''>
