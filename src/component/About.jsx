    ...
    <div id="about" >
      ...
      <div className=" p-10 flex  justify-center flex-col gap-4 w-[100vw]  " >
        <div className="text-center">
          ...
          <p className="  lg:w-[50vw] flex justify-center mx-auto mt-3   md:w-10/12 text-lg  text-center "> Here, you'll find more information about me, what I do, and my current skills mostly in terms of programming and technology</p>
          <div className="flex items-center justify-between w-11/12 mx-auto">
          </div>
          <div className="flex flex-col lg:w-10/12 items-center mx-auto lg:flex-row">
            <img alt="" className="rounded-lg border  lg:mt-10 object-cover md:h-[15rem] md:w-[18rem] mx-auto h-[15rem]"
